...
<div class="relative flex flex-col justify-center min-h-screen overflow-hidden p-8 lg:p-4">
    <div
        class="w-full p-6 m-auto bg-white border-t border-accent rounded shadow-lg shadow-accent lg:max-w-md">
        ...
        <form class="mt-6">
            <div>
                ...
                <input type="email"
                    class="block w-full px-4 py-2 mt-2 text-accent bg-white border rounded-md focus:border-accent focus:ring-accent focus:outline-none focus:ring focus:ring-opacity-40">
            </div>
            <div class="mt-4">
                <div>
                ...
                <div class="mt-6">
                    <button
                        class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-accent rounded-md hover:bg-accent focus:outline-none focus:bg-accent">
                        Login
                    </button>
                </div>
        </form>
        <p class="mt-8 text-xs font-light text-center text-gray-700"> Don't have an account? <a href="#"
                class="font-medium text-accent hover:underline">Sign up</a></p>
    </div>
</div>
</body>
